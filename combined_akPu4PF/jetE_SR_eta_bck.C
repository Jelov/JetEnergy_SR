...
void jetE_SR_eta()
{
	...
	double Imean_pt_akPu4PF[nEtaBins];
	double ImeanErr_pt_akPu4PF[nEtaBins];
	double Isigma_pt_akPu4PF[nEtaBins];
	double IsigmaErr_pt_akPu4PF[nEtaBins];
	fit_combine(tc_qcd , Var_eta, etaBin , nEtaBins, AllCut , Imean_pt_akPu4PF, ImeanErr_pt_akPu4PF, Isigma_pt_akPu4PF, IsigmaErr_pt_akPu4PF);

	double Bmean_pt_akPu4PF[nEtaBins];
	double BmeanErr_pt_akPu4PF[nEtaBins];
	double Bsigma_pt_akPu4PF[nEtaBins];
	double BsigmaErr_pt_akPu4PF[nEtaBins];  
	fit_combine(tc_bjt , Var_eta, etaBin , nEtaBins, B_AllCut , Bmean_pt_akPu4PF, BmeanErr_pt_akPu4PF, Bsigma_pt_akPu4PF, BsigmaErr_pt_akPu4PF);

  double csvBmean_pt_akPu4PF[nEtaBins];
  double csvBmeanErr_pt_akPu4PF[nEtaBins];
  double csvBsigma_pt_akPu4PF[nEtaBins];
  double csvBsigmaErr_pt_akPu4PF[nEtaBins];
  fit_combine(tc_bjt , Var_eta, etaBin , nEtaBins, csvB_Allcut , csvBmean_pt_akPu4PF, csvBmeanErr_pt_akPu4PF, csvBsigma_pt_akPu4PF, csvBsigmaErr_pt_akPu4PF);

  double csvLmean_pt_akPu4PF[nEtaBins];
  double csvLmeanErr_pt_akPu4PF[nEtaBins];
  double csvLsigma_pt_akPu4PF[nEtaBins];
  double csvLsigmaErr_pt_akPu4PF[nEtaBins];
//  fit_combine(tc_qcd , Var_eta, etaBin , nEtaBins, csvL_Allcut , csvLmean_pt_akPu4PF, csvLmeanErr_pt_akPu4PF, csvLsigma_pt_akPu4PF, csvLsigmaErr_pt_akPu4PF);
	...
	measurement="JES";
	Muti_Plot(measurement,selection, lineKind , AllCut, Var_eta, 3, nEtaBins , etaBin , mean2D_pt_akPu4PF, meanErr2D_pt_akPu4PF);
	measurement="JER";
	Muti_Plot(measurement,selection, lineKind , AllCut, Var_eta, 3, nEtaBins , etaBin , sigma2D_pt_akPu4PF, sigmaErr2D_pt_akPu4PF);
