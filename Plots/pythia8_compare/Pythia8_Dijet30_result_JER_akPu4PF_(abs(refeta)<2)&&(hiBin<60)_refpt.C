...
//=========  (Mon Apr 18 03:08:51 2016) by ROOT version6.02/13
   ...
   gStyle->SetOptFit(1);
   Can_result_1->Range(-2.301397,-0.3648558,237.5545,0.5153406);
   ...
   0.05191458,
   0.07751978};
   TGraphErrors *gre = new TGraphErrors(11,Graph_fx1003,Graph_fy1003,Graph_fex1003,Graph_fey1003);
   gre->SetName("Graph");
   gre->SetTitle("some title_0");
   gre->SetFillColor(1);
   gre->SetFillStyle(0);
   
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","some title_0",100,24,216);
   Graph_Graph1003->SetMinimum(0.08340538);
   Graph_Graph1003->SetMaximum(0.2886666);
   ...
   Graph_Graph1004->SetMinimum(-0.3088433);
   Graph_Graph1004->SetMaximum(0.4593281);
