...
//	fit_combine(tc_akPu4PF , Var_eta, etaBin , nEtaBins, Heavy_AllCut , Hmean_pt_akPu4PF_ce0to30, HmeanErr_pt_akPu4PF_ce0to30, Hsigma_pt_akPu4PF_ce0to30, HsigmaErr_pt_akPu4PF_ce0to30);
	...
	Muti_Plot_JES_ce0to30(measurement, lineKind , AllCut, Var_eta, 1, nEtaBins , etaBin , mean2D_pt_akPu4PF_ce0to30, meanErr2D_pt_akPu4PF_ce0to30);

  measurement="JER_akPu4PF";

  Muti_Plot_JER_ce0to30(measurement, lineKind , AllCut, Var_eta, 1, nEtaBins , etaBin , sigma2D_pt_akPu4PF_ce0to30, sigmaErr2D_pt_akPu4PF_ce0to30);
...
//	fit_combine(tc_akPu4PF , Var_eta, etaBin , nEtaBins, Heavy_AllCut , Hmean_pt_akPu4PF_ce30to100, HmeanErr_pt_akPu4PF_ce30to100, Hsigma_pt_akPu4PF_ce30to100, HsigmaErr_pt_akPu4PF_ce30to100);
	...
	Muti_Plot_JES_ce30to100(measurement, lineKind , AllCut, Var_eta, 1, nEtaBins , etaBin , mean2D_pt_akPu4PF_ce30to100, meanErr2D_pt_akPu4PF_ce30to100);

  measurement="JER_akPu4PF";

  Muti_Plot_JER_ce30to100(measurement, lineKind , AllCut, Var_eta, 1, nEtaBins , etaBin , sigma2D_pt_akPu4PF_ce30to100, sigmaErr2D_pt_akPu4PF_ce30to100);
