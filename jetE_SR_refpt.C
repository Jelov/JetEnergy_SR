...
*/
	...
	Muti_Plot_JES_ce0to30(measurement, lineKind , AllCut, Var_pt, 3, nPtBins , ptBin , mean2D_pt_akPu4PF_ce0to30, meanErr2D_pt_akPu4PF_ce0to30);

  measurement="JER_akPu4PF";

  Muti_Plot_JER_ce0to30(measurement, lineKind , AllCut, Var_pt, 3, nPtBins , ptBin , sigma2D_pt_akPu4PF_ce0to30, sigmaErr2D_pt_akPu4PF_ce0to30);
...
//// end of centrality 0-30% ///
	...
	Muti_Plot_JES_ce30to100(measurement, lineKind , AllCut, Var_pt, 3, nPtBins , ptBin , mean2D_pt_akPu4PF_ce30to100, meanErr2D_pt_akPu4PF_ce30to100);

  measurement="JER_akPu4PF";

  Muti_Plot_JER_ce30to100(measurement, lineKind , AllCut, Var_pt, 3, nPtBins , ptBin , sigma2D_pt_akPu4PF_ce30to100, sigmaErr2D_pt_akPu4PF_ce30to100);
